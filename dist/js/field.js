...
Nova.booting(function (Vue, router) {
    Vue.component('index-percentage', __webpack_require__(3));
    Vue.component('detail-percentage', __webpack_require__(6));
    Vue.component('form-percentage', __webpack_require__(9));
});
      ...
      _c("template", { slot: "value" }, [
        _vm.field.value == null
          ...
          : _c("div", [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.field.value.toFixed(_vm.field.precision)) +
                  "%\n        "
              )
            ])
      ])
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "relative" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "absolute percentage-shift" }, [_vm._v("%")])
        ])
      ])
    ],
    2
